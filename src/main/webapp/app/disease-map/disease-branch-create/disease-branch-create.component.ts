...
import { IMapAuthorization, MapAuthorizations } from 'app/shared/util/authorization-util';
...
export class DiseaseBranchCreateComponent implements OnInit {
    ...
    public authorizations: IMapAuthorization[];

    constructor(protected diseaseMapService: DiseaseMapService
        , protected route: ActivatedRoute) { }

    ngOnInit() {
        this.authorizations = MapAuthorizations;
