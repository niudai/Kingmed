...
import { DiseaseXiAnComponent } from 'app/entities/disease-xi-an/disease-xi-an.component';
...
describe('Component Tests', () => {
    describe('DiseaseXiAn Management Component', () => {
        let comp: DiseaseXiAnComponent;
        let fixture: ComponentFixture<DiseaseXiAnComponent>;
        let service: DiseaseXiAnService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterElasticsearchSampleApplicationTestModule],
                declarations: [DiseaseXiAnComponent],
                providers: [
                    {
                ...
                .overrideTemplate(DiseaseXiAnComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(DiseaseXiAnComponent);
